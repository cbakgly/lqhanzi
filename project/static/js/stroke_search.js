...
$(document).ready(function()
{
    ...
    $(document).on('mouseover', '.hanzi-item', function()
    {
        ...
        $("#btip").css({ "visibility":"visible","left":offset.left-new_left_offset-5,"top":offset.top-btip_height-12});
...
function render_stroke_result(data)
{
    ...
    for (var i=0;i<len;i++)
    {
        ...
        else if(data[i].source == 2)// 如果是台湾异体字
        {
            ...
            {
                char = '<li><a class="hanzi-item" target="_blank" href="/variant_detail?source=2&type=pic&text=';
