    ...
    if (data[TAIWAN].length > 0) {  // 台湾异体字
        ...
        for (var j = 0; j < hanzi_set.length; j++) {
            ...
            if (hanzi_set[j].hanzi_char != '') {
                char += '<p class="hanzi-normal"><a target="_blank" href="/hanzi/variant_detail?source=' + source + '&type=char&text=' + hanzi_set[j].hanzi_char + '">';
                char += '[<span>' + hanzi_set[j].hanzi_char + '</span>]</a></p>';
            } else {
                char += '<p class="hanzi-normal"><a target="_blank" href="/hanzi/variant_detail?source=' + source + '&type=pic&text=' + hanzi_set[j].hanzi_pic_id + '">';
            ...
            for (var k = 0; k < variants.length; k++) {
                if (variants[k].hanzi_char != '') {
                    char += '<a target="_blank" href="/hanzi/variant_detail?source=' + source + '&type=char&text=' + variants[k].hanzi_char + '">';
                    char += '<span class="normal">' + variants[k].hanzi_char + '</span></a>';
                } else {
                    char += '<a target="_blank" href="/hanzi/variant_detail?source=' + source + '&type=pic&text=' + variants[k].hanzi_pic_id + '">';
