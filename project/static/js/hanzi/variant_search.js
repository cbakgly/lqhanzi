...
function render_variant_result(res) {
    ...
    var search_word = $('#variant_searchinput').val();
    ...
    if (data[TAIWAN].length > 0) {  // 台湾异体字
        ...
        for (var j = 0; j < hanzi_set.length; j++) {
            ...
            if (hanzi_set[j].hanzi_char != '') {
                ...
                char += '[<span ';
                if (hanzi_set[j].hanzi_char == search_word)
                    char += 'class="keyword" ';
                ...
                char +='[<span ';
                if (hanzi_set[j].hanzi_pic_id == search_word)
                    char += 'class="keyword" ';
            ...
            for (var k = 0; k < variants.length; k++) {
                if (variants[k].hanzi_char != '') {
                    ...
                    char += ' target="_blank" href="/variant_detail?q=' + variants[k].hanzi_char + '">';
                    char += '<span class="normal ';
                    if (variants[k].hanzi_char == search_word)
                        char += 'keyword';
                    ...
                    char += ' target="_blank" href="/variant_detail?q=' + variants[k].hanzi_pic_id + '">';
                    char += '<span ';
                    if (variants[k].hanzi_pic_id == search_word)
                        char += 'class="keyword"';
    ...
    if (data[HANYU].length > 0) {  // 汉语大字典
        ...
        for (var j = 0; j < hanzi_set.length; j++) {
            if (hanzi_set[j].hanzi_char != '') {
                char += '<p class="hanzi-normal"><a ';
                if (hanzi_set[j].variant_type == 3) char += 'class="instruction-generic-variant-char"';
                else if (hanzi_set[j].variant_type == 2) char += 'class="instruction-generic-variant-std-char"';
                char += ' target="_blank" href="/variant_detail?q=' + hanzi_set[j].hanzi_char + '">';
                char += '[<span ';
                if (hanzi_set[j].hanzi_char == search_word)
                    char += 'class="keyword"';
                ...
                char += ' target="_blank" href="/variant_detail?q=' + hanzi_set[j].hanzi_pic_id + '">';
                char += '[<span ';
                if (hanzi_set[j].hanzi_pic_id == search_word)
                    char += 'class="keyword"';
