...
class HanziSet(models.Model):
    ...
    hanzi_char = models.CharField(u'文字', null=True, max_length=8, db_index=True)
...
class UserTaskProfile(models.Model):
    user = models.ForeignKey(User)
    last_split_id = models.IntegerField(blank=True, default=0)
    last_dedup_id = models.IntegerField(blank=True, default=0)
    last_input_id = models.IntegerField(blank=True, default=0)
